                ...
                <form ref={formRef} onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-12">
                  ...
                  <div className="md:col-span-2 flex flex-col gap-4">
                    ...
                    <button
                      ...
                      className="py-6 bg-green-600 hover:bg-green-700 text-white text-[10px] font-black uppercase tracking-[0.4em] transition-all shadow-xl flex items-center justify-center gap-4 group rounded-sm"
                    >
